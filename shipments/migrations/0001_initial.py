# Generated by Django 4.2.17 on 2025-02-23 18:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shipments.receiver')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shipments.sender')),
            ],
        ),
        migrations.CreateModel(
            name='ShipmentCost',
